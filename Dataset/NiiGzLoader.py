...
from torchio import SubjectsDataset, Subject, ScalarImage
import os


class NiiGzLoader(SubjectsDataset):
    ...
    def _get_subjects(
        ...
        for subject_dir in sorted(subjects_dir.iterdir()):
            ...
            for modality in self.modalities:
                ...
                niiGzPath = os.path.join(path,  modality + ".nii.gz")
                images_dict[modality] = ScalarImage(niiGzPath)
...
if __name__ == '__main__':
    dataset = NiiGzLoader(
        root_dir='/Volumes/GoogleDrive/我的雲端硬碟/KaggleBrain/rsna-preprocessed')

    loader = DataLoader(dataset, batch_size=32, shuffle=False)
    print(loader.dataset[0])
    print(loader.dataset[0]['T1w']['data'].shape)
